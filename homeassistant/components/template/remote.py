...
async def async_setup_entry(
    ...
    """Set up a Template remote."""
    device = hass.data[DOMAIN].devices[config_entry.entry_id]
    remote = TemplateRemote(
        device,
        Store(hass, CODE_STORAGE_VERSION, f"template_remote_{device.unique_id}_codes"),
        Store(hass, FLAG_STORAGE_VERSION, f"template_remote_{device.unique_id}_flags"),
    )
    async_add_entities([remote], False)


class TemplateRemote(RemoteEntity, RestoreEntity):
    """Representation of a Template remote."""
